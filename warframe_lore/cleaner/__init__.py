...
Sous-modules (un fichier = une responsabilité) :
    * preprocessing : strip HTML, commentaires, tables, Lua, transclusion ;
    * templates     : suppression/rendu des templates MediaWiki ;
    * sections      : filtrage des sections gameplay vs lore ;
    * formatting    : normalisation des liens, markdown, dialogue, headings ;
    * pipeline      : classe :class:`WikitextCleaner` qui orchestre le tout.
...
l'exécution (principle SOLID *Dependency Injection*).
"""
...
from .pipeline import WikitextCleaner  # noqa: E402  (après définitions)
